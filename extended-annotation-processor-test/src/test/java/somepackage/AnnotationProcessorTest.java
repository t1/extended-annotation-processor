...
public class AnnotationProcessorTest {
    ...
    public void shouldHaveGeneratedInterface() {
        assertThat(GENERATED_TEST_SOURCES.resolve("somepackage/GeneratedInterface.java"))
                .hasContent(""
                        + "package somepackage;\n"
                        + "\n"
    ...
    public void shouldHaveGeneratedRootClass() {
        assertThat(GENERATED_TEST_SOURCES.resolve("GeneratedRootClass.java"))
                .hasContent(""
    ...
    public void shouldHaveGeneratedClass() {
        assertThat(GENERATED_TEST_SOURCES.resolve("somepackage/GeneratedClass.java"))
                .hasContent(""
                        + "package somepackage;\n"
                        + "\n"
